...
+ (NSDate *)dateFromRFC822String:(NSString *)dateString {
	...
	if (!date) DLog(@"Could not parse RFC822 date: \"%@\" Possibly invalid format.", dateString);
	return date;
...
+ (NSDate *)dateFromRFC3339String:(NSString *)dateString {
	...
	if (!date) DLog(@"Could not parse RFC3339 date: \"%@\" Possibly invalid format.", dateString);
	return date;
